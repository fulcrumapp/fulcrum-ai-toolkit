...
node --test test/app-scorecard.test.mjs test/app-approval.test.mjs test/agent-plugin-manifest.test.mjs test/agent-skill-frontmatter.test.mjs test/build-m365-bundle.test.mjs test/validate-entrypoint-frontmatter.test.mjs
```
