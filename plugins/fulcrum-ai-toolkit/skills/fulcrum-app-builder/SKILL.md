...
> Source: [App MCP PR #28](about:blank) at commit [`f8c041e`](about:blank) defines the tool contract used by this workflow.
...
> Source: [App MCP PR #28](about:blank) documents the create/update sequence, mixed choice inputs, default report behavior, and preservation guard.
