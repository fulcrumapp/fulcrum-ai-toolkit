...
> Source: [App MCP PR #28](about:blank) at commit [`f8c041e`](about:blank) defines the generated artifacts used here. The bridge behavior comes from the [Fulcrum App Extensions introduction](https://docs.fulcrumapp.com/docs/app-extensions-introduction).
