...
> Source: [App MCP PR #28](about:blank) at commit [`43e68bb`](about:blank) defines the generated artifacts used here. The bridge behavior comes from the [Fulcrum App Extensions introduction](https://docs.fulcrumapp.com/docs/app-extensions-introduction).
...
> Source: The payload and inline-bootstrap semantics above are materially adapted from the generated templates in [App MCP PR #28](about:blank) and the [public App Extensions quick start](https://docs.fulcrumapp.com/docs/app-extensions-introduction#quick-start).
...
> Source: [App MCP PR #28](about:blank) defines the exact tool arguments and generated Reference File workflow.
